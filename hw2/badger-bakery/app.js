...
function calculateSubtotal() {
	...
	return bagelQuantity * 1.5 + donutQuantity * 1.00 + muffinQuantity * 2.00 + pieQuantity * 4.50 + cakeQuantity * 7.00;
}

function calculateSalesTax() {
	const state = document.getElementById("stateTax").value;
	const sale_tax = SALES_TAX[state];
	return roundMoney(calculateSubtotal() * sale_tax);
}
